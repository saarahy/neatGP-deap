...
def eaSimple(population, toolbox, cxpb, mutpb, ngen, neat, h, params,n,stats=None,
    ...
    if neat:
        SpeciesPunishment(population,params)
    ...
    for gen in range(1, ngen+1):
        ...
        if neat:
            offspring=p_selection(population)
        else:
        ...
        if neat:
            offspring=neatGP(toolbox,offspring,cxpb,mutpb,n)
        else:
